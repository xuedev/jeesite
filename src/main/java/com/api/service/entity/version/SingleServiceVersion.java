 ...
 */
package com.api.service.entity.version;
 ...
 * @version 2018-07-24
 */
public class SingleServiceVersion extends DataEntity<SingleServiceVersion> {
	...
	public SingleServiceVersion() {
		super();
	}

	public SingleServiceVersion(String id){
		super(id);
	}
