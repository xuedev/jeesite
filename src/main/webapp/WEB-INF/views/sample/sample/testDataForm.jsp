...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sample/testData/">示例列表</a></li>
		<li class="active"><a href="${ctx}/sample/testData/form?id=${testData.id}">示例<shiro:hasPermission name="sample:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sample:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/sample/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sample:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
