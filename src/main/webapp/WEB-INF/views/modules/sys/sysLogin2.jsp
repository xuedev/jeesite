...
<body>
	...
	<div class="footer">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="http://linjinsuo.com/" target="_blank">临交中心</a> ${fns:getConfig('version')}
	</div>
